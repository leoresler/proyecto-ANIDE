...
export default function CompletarDatosUser() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        interests: auth.user.interests || [], // array de intereses
    });
    ...
    return (
        ...
        <div className="bg-white text-black p-6 max-w-lg mx-auto">
            {type === "institucion" ? (
                <div>
                    <h2 className="text-xl font-bold">Completar datos institución</h2>
                    {/* Aquí luego agregaremos campos específicos de institución */}
                </div>
            ) : (
                <div>
